...
import {  getAllProductsForAdmin, updateProductAdmin } from '../../redux/Action/product';
import { useParams } from 'react-router-dom';

const AdminDashboardUpdateAllPizza = () => {
  ...
  const { allCategory } = useSelector((state) => state.category);
    ...
    const submitHandler = async (e) => {
        e.preventDefault();
     await dispatch(updateProductAdmin(params.slug,name,description,stock,price,category,image));
...
export default AdminDashboardUpdateAllPizza